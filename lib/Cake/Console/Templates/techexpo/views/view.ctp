...
<?php
  echo "<?php echo \$this->element('admin-breadcrumbs',array('pageName'=>'viewlocation'));?>"; ?>
?>
<div class="title-pad">
  <div class="title">
    <h5><?php echo " __('{$singularHumanName}');";?></h5>
  </div>
</div>
	...
	if (!empty($associations['belongsTo'])) {
		foreach ($associations['belongsTo'] as $alias => $details) {
			if ($field === $details['foreignKey']) {
				$isKey = true;
				echo "\t\t<tr><td width='20%' align='right' valign='top'><?php echo __('" . Inflector::humanize(Inflector::underscore($alias)) . "'); ?><</td>\n";
