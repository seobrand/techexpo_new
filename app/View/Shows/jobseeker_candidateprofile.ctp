                    	...
                    	<div class="dash_ev_list" >
                        	...
                        	<?php
							  ...
							  <div class="upcomingevents">
								...
								if($eventValReg==0)
								echo $this->Html->link('Register',array('controller'=>'shows','action'=>'eventRegister',$value['Show']['id']),array('escape'=>false,'class'=>'viewMore','style'=>'float:right')); 
								else
								echo $this->Html->link($this->Html->image('registered.png'),array('controller'=>'candidates','action'=>'eventinfo',$value['Show']['id']),array('escape'=>false,'class'=>'viewMore','style'=>'float:right')); 
