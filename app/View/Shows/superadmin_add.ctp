...
jk(document).ready(function() {
	...
	//	jk(this).colorbox.resize();
	 ...
	 jk(".start_dt_set").datepicker({ dateFormat: "yy-mm-dd" });
	 jk(".end_dt_set").datepicker({ dateFormat: "yy-mm-dd" });
	 ...
	 jk("#ShowLocationId").change(function(){
		//alert(jk(this).val());
	
		jk.ajax({
        url: "<?php echo FULL_BASE_URL.router::url('/',false);?>superadmin/shows/getTravelDt",
        type: "post",
        data: {'locationid':jk(this).val()},
		success: function(data) {
	    if(data)
		tinyMCE.get('ShowShowTravelDir').setContent(data);
	 ...
	 jk('#submit_first').click(function(){
		...
		var startdatepicker =  jk('#startdatepicker').val();

		var datepicker = jk("#startdatepicker").val().split("-");
	    var startdate = new Date();
	    // 2 week prior to show date by Jitendra 29 July 2013 (task #1311)
	    startdate.setFullYear(parseInt(datepicker[0]), parseInt(datepicker[1]), parseInt(datepicker[2])-14);
	    jk("#start_dt").val(startdate.getFullYear()+'-'+startdate.getMonth()+'-'+startdate.getDate());
	 	// 2 week after to show date by Jitendra 29 July 2013 (task #1311) 
	    startdate.setFullYear(parseInt(datepicker[0]), parseInt(datepicker[1]), parseInt(datepicker[2])+14);
	    jk("#end_dt").val(startdate.getFullYear()+'-'+startdate.getMonth()+'-'+startdate.getDate()); 		
...
jk(function() {
	   	...
	   	if (jk('#startdatepicker').length && jk('#enddatepicker').length)
		{ 
			jk( "#startdatepicker" ).datepicker({
				dateFormat: "yy-mm-dd" ,
				 minDate: '0',
				defaultDate: "+1d",
				changeMonth: false,
				...
				onClose: function( selectedDate ) {
					jk( "#enddatepicker" ).datepicker( "option", "minDate", selectedDate );
				}
			}).datepicker( "option", "maxDate", jk('#enddatepicker').val() );
	
			jk( "#enddatepicker" ).datepicker({
				dateFormat: "yy-mm-dd", 
				 minDate: '0',
				defaultDate: "+1d",
				changeMonth: false,
				numberOfMonths: 1,
				onClose: function( selectedDate ) {
					jk( "#startdatepicker" ).datepicker( "option", "maxDate", selectedDate );
				}
			}).datepicker( "option", "minDate", jk('#startdatepicker').val() );
		}
...
<div class="display_row">
      <div class="table">
	  <?php  echo $this->Form->create('Show', array('enctype' => 'multipart/form-data','type'=>'post') ); ?> 
        <table  cellspacing="0" cellpadding="0" border="0" align="center">
          ...
          <!-------------------------------step1 start ------------------------------------------------------------>
            ...
            <tr class="create_first">
              ...
              <td align="left" valign="top"><?php echo $this->Form->input('ShowsHome.display_name',array('label'=>'','class'=>'inputbox1'));?></td>
            </tr>
            
            <tr class="create_first">
              <td align="right" valign="middle">Show Display Requirements</td>
              <td align="left" valign="top">
               <?php echo $this->Form->input('ShowsHome.special_message',array('label'=>'','type'=>'text','class'=>'inputbox1'));?>
				</td>
            </tr>
                <tr class="create_first">
           ...
           <!-------------------------------step2 start ------------------------------------------------------------>
            ...
            <?php //  echo $this->Html->link('Click Here to create new resume set', array('controller'=>'sets','action'=>'add'),array('target'=>'blank','escape'=>false)); ?> 
            </td>
            </tr> 
            ...
            <td align="left" valign="top"><?php echo $this->Form->input('start_dt',array('label'=>'','class'=>'inputbox1 start_dt_set','id'=>'start_dt','error'=>false));?></td>
            </tr>
            <tr class="create_set create_second">
            <td align="right" valign="middle"><span class="required"></span>End Date: yyyy-mm-dd:</td>
            <td align="left" valign="top"><?php echo $this->Form->input('end_dt',array('label'=>'','class'=>'inputbox1 end_dt_set','id'=>'end_dt','error'=>false));?></td>
            </tr>
            <tr class="create_set create_second">
          ...
          <tr class="create_forth" valign="right" id="clearances_tr">
              ...
              <td align="left" valign="top"><?php echo $this->Form->input('sec_clearance_list',array('label'=>'','options'=>$ck,'type'=>'select','multiple'=>true,'selected'=>array('1','3920','3919','3918','3917','3916','3915','3914','3913','3922'), 'size'=>'10','error'=>false));?>
        ...
        <!-------------------------------step6 Start ------------------------------------------------------------>
           ...
           <!--   <input name="" type="button" value="Next" class="next_btn cursorclass ui-state-default ui-corner-all" id="submit_sixth">-->
