          ...
          <div class="qunt_in_bx">
            <div id="jobseekers" class="content_products">
              <ul class="news_list">
                ...
                <li <?php if($count_job==$i) echo "class='last'"; ?> >
                  <?php if(file_exists(TESTIMONIAL.$testi_job['Testimonial']['logo_file'])) {
					 // echo $this->Html->image('testimonial/resized_'.$testi_job['Testimonial']['logo_file']);
					 ?>
                  <img src="<?php echo $this->webroot; ?>thumbnail.php?file=<?php echo 'img/testimonial/'.$testi_job['Testimonial']['logo_file'];?>&maxw=59&maxh=100"  />
                  <?php }
					  else
            ...
            <div id="employers" class="content_products">
              <ul class="news_list">
                ...
                <li <?php if($count_job==$i) echo "class='last'"; ?> >
                  <?php if(file_exists(TESTIMONIAL.$testi_emp['Testimonial']['logo_file'])) 
				  		{
					  		//echo $this->Html->image('testimonial/resized_'.$testi_emp['Testimonial']['logo_file']);
							?>
                            <img src="<?php echo $this->webroot; ?>thumbnail.php?file=<?php echo 'img/testimonial/'.$testi_emp['Testimonial']['logo_file'];?>&maxw=59&maxh=100"  />
                            <?php
						}
					  	else
						{
