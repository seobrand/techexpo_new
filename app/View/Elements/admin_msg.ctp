...
// call popup message when sucess message show
popmsg(document).ready(function(){
      ...
      <table cellpadding="0" cellspacing="0" border="0" width="" style="font-family:Verdana, Arial, Helvetica, sans-serif;font-size:11px;">
        <tr>
		 ...
		 echo '<td style="background-color:#FFFFFF;border:none;">'.$this->Html->image('success.png',array('alt'=>'success','title'=>'success','style'=>'width:40px;'));
		  echo'</td><td style="background-color:#FFFFFF;border:none;">'.$this->Session->flash().'</td>';
  ...
  <div id="message-error" class="message message-error">
    <div class="image"> <?php echo $this->Html->image('error.png',array('alt'=>'Error','title'=>'Error'));?> </div>
    <div class="text">
      <!-- <h6>Error Message</h6>-->
      <span>
