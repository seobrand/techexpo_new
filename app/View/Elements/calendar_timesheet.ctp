<?php  
	  ...
	  $style = isset($style) ? $style : 'width:130px;height:13px;';
	  ...
	  echo $form->input($dateN, array('label'=>$label,'id'=>$dateId,'div'=>false,'value'=>$defaultDate,'style'=>$style,'class'=>'input_01','onblur'=>'convert_date()'));	  
		?>
		<?php echo $html->image('calendar_icon.jpg',array('alt'=>'Cal','align'=>'absmiddle','onclick'=>"displayCalendar(document.getElementById('".$dateId."'),'".CALENDAR_DATE_FORMAT."',this)",'div'=>false));		
?>
