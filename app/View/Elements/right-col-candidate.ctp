<div class="login_box">
  ...
  <div class="login_mid">
    <?php
		...
		$cookie_username 		= ($this->Session->read('remember.email')) ? $this->Session->read('remember.email') : '';
    ...
    <div class="email_input"> Email<br>
      <?php echo $this->Form->input('email',array('label'=>'','class'=>'input_03','width'=>'200px','div'=>false,'value'=>$cookie_username));?> </div>
    <div class="email_input"> Password<br>
      <?php echo $this->Form->input('password',array('label'=>'','class'=>'input_03','width'=>'100px','div'=>false));?> </div>
    <div class="email_input">
	  ...
	  if($cookie_remember_me == 1) {
	   		echo $this->Form->input('remember_me',array('type'=>'checkbox','label'=>'','value'=>1,'class'=>'','div'=>false,'checked'=>'checked'));
		}
		else {
			echo $this->Form->input('remember_me',array('type'=>'checkbox','label'=>'','value'=>1,'class'=>'','div'=>false));
		}	   
	   ?></td>
      ...
      <div class="f_right"><?php echo $this->Form->submit('login_bt.jpg', array('id'=>'button1','div'=>false));?></div>
    </div>
    <div class="email_input">
      <div id='basic-modal'>
        <?php	echo $this->Html->link('Request a password reminder','javascript:void(0);',array('class'=>'basic')); ?>
      </div>
    </div>
    <div class="condidte_registration_bt"><?php echo $this->Html->link($this->Html->image('candidate_registration_bt.jpg',array('alt'=>'Candidate Registration','title'=>'Candidate Registration')),array('controller'=>'users','action'=>'candidateRegistration'),array('div'=>false,'escape'=>false)); ?></div>
