  ...
  <div id="container">
    <div class="lf_col_inner">
        ...
        <div class="whiteB_bottom">
          ...
          <div class="content">
           ...
           <!-- <br />
            ...
            <br />
            <h2 class="mana_subheading">4. Keywords </h2>
            <br />
            ...
            <br />
            <h2 class="mana_subheading">5. Location of the Job </h2>
            <br />
            <div class="gray_full_top"></div>
            <div class="gray_full_mid">
              <ul class="form_list manage_resume_form">
	  ...
	  <?php echo $this->Form->input('JobPosting.location_city',array('label'=>false,'div'=>false,'class'=>'big237_textfield','style'=>'width:248'));?></div>
            ...
            <br />
            <h2 class="mana_subheading">6. Position Type &amp; Salary </h2>
            <br />
            <div class="gray_full_top"></div>
            <div class="gray_full_mid">
              <ul class="form_list manage_resume_form">
                ...
                <li>
                  ...
                  <div class="form_rt_col1">
                    ...
                    <div class="dropdown_resume4 float_left">
                      <?php echo $this->Form->input('JobPosting.salary_type_code',array('type'=>'select','options'=>$salarytype,'label'=>false,'div'=>false,'default'=>'2884'));?>
                    </div>
            ...
            <br />
            <h2 class="mana_subheading">7. Security Clearance Required ?</h2>
            <div class="gray_full_top"></div>
            <div class="gray_full_mid">
              <ul class="form_list manage_resume_form">
                <li>
            ...
            <br />
            <h2 class="mana_subheading">8. Please enter a detailed job description.</h2>
            <div class="gray_full_top"></div>
            <div class="gray_full_mid">
              <ul class="form_list manage_resume_form">
                <li>
