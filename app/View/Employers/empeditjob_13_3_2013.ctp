                ...
                <li>
                  ...
                  <div class="form_rt_col1" style="width:435px;">
                    <div class="dropdown_resume2 float_left margin_zero">
                      <?php //echo $this->Form->input('JobPosting.location_state',array('type'=>'select','options'=>$states,'label'=>false,'div'=>false,'onChange'=>'onChangeAjaxGet("'.FULL_BASE_URL.router::url('/',false).'employers/jobcity/",this.value,"cityDiv")'));
...
<!--</div>-->
					  ...
					  <?php //echo $this->Form->input('JobPosting.location_city',array('label'=>false,'div'=>false,'class'=>'big237_textfield'));?>
                    <div class="clear"></div>
                  </div>
                </li>
              </ul>
