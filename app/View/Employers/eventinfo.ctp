...
<?php $registerEventCount = $common->checkRegisterEvent($regEventInfo['Show']['id'],$employerID);?>
    ...
    <div class="lf_col_inner">
      ...
      <div class="whiteB_mid">
        <div class="whiteB_bottom">
          <h1 class="bluecolor"><?php  if(!empty($regEventInfo['ShowsHome']['display_name'])) echo $regEventInfo['ShowsHome']['display_name']; else  echo $regEventInfo['Show']['show_name'];?><?php // echo $regEventInfo['Show']['show_name'];?></h1>
          <div class="content">
            <h2 class="mana_subheading">
			 <?php if(!empty($regEventInfo['ShowsHome']['special_message'])) echo $regEventInfo['ShowsHome']['special_message']; ?>			
			<?php /* echo $regEventInfo['Show']['show_name'];?> 
              ...
              <div class="new_event_gray_top1">
                <div class="new_event_gray_bot1">
                    ...
                    <span class="social_icons">
                     <?php 
						  ...
						  $eventSharetitle = $regEventInfo['Show']['show_name'];?>
                           <a href="http://www.facebook.com/sharer.php?u=<?php echo FULL_BASE_URL.router::url('/',false).'shows/view/'.$regEventInfo['Show']['id'];?>&t=event" target="_blank"><?php echo $this->Html->image('images/face.jpg');?></a>
                  ...
                  <p><strong>Date & Time:</strong> 
                  	<span class="event_datetime_text">
                    <?php if($regEventInfo['Show']['show_end_dt']!=''):?>
                    ...
                    <?php endif;?>
                    <?php echo $regEventInfo['Show']['show_hours'];?> </span><p></p>
                    <?php /* ?>
					<?php echo $regEventInfo['Show']['show_hours'];?> </span></p>
				...
				?>
                   ...
                   <?php /*?> &nbsp;&nbsp;<a href="<?php echo ICAL_PATH;?>/ShowsDocument/ics/<?php echo $regEventInfo['Show']['ics_file'];?>" target="_blank"><?php echo $this->Html->image("images/add_outlook.jpg",array('alt'=>'Outlook'));?></a><?php */?>
                                        <?php
					 echo $this->Html->link($this->Html->image("images/add_outlook.jpg"), array('controller'=>'users','action'=>'downloadfilehome',$regEventInfo['Show']['ics_file']),array('escape'=>false));
					 					 }else{
											
					  echo $this->Html->link($this->Html->image("images/add_outlook.jpg",array('alt'=>'Outlook')), array('controller'=>'users','action'=>'icalenderOrg',$regEventInfo['Show']['id']),array('escape'=>false));
                    ...
                    <? 	$register_check=$common->isEmployerRegisteredForEvent($regEventInfo['Show']['id'],$employerID);
					if($register_check) { ?> 
                    <span style="margin-left:10px;vertical-align:7px;"><?php echo $this->Html->image("registered.png");?> </span>
			 		<?php } ?>
                    </p>
            ...
            <div class="new_event_gray_mid1">
              <div class="new_event_gray_top1">
                <div class="new_event_gray_bot1">
                  <p class="bigfont" style="font-size:14px; color:#2D2D2D;">Our professional hiring events have benefited nearly a million attendees since 1993. We look forward to helping you advance your career and saving you time in your job search by providing you the opportunity to meet face to face with the nation's leading companies. Thank you for joining us; we look forward to meeting you at 
                    our expos! </p>
                  <ul class="list">
                    ...
                    <li  style="font-size:14px">Pre-register online  This will allow recruiters to find your resume & schedule face-to-face interviews before the event. It also saves you time when 
                    ...
                    <li  style="font-size:14px">Prepare & practice your brief personal description of your professional skills, unique abilities, past successful 
                      accomplishments & relevant experience.</li>
                  ...
                  <span style="font-size:14px;">If you have any questions or require further information, please e-mail <a href="mailto:Amanda@TechExpoUSA.com">Amanda@TechExpoUSA.com.</a> </span>
                </div>
              </div>
            </div>
            <div class="clear"></div>
            <div class="new_event_gray_mid1">
              <div class="new_event_gray_top1">
                <div class="new_event_gray_bot1">
                  ...
                  <?php }else{ ?>
                  <span>The exhibitors of this event have not yet been posted. Please check back with us 2 weeks prior to the event.</span>
                  <?php } ?>
                </div>
              </div>
            </div>
