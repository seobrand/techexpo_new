...
$(function(){	
	...
	$(".resumedblistdrop input:checkbox").click(function(){
	    var pos = $(".resumedblistdrop input:checkbox").index(this);
	    if(pos == 0){
	        $(".resumedblistdrop input:checkbox").not(this).attr("checked", false);
	    }
	    else{
	        $(".resumedblistdrop input:checkbox:first").attr("checked", false);
	    }
	});
});
</script>
    ...
    <div class="whiteB_mid border_mid">
        <div class="whiteB_bottom border_btm">
          <div class="padding_dashboard employee_fixheight">
            ...
            <h2 align="center"> No recent application available</h2>
            <?php } ?>
          </div>
        </div>
      </div> <br/>
      ...
      <div class="whiteB_mid border_mid">
        <div class="whiteB_bottom border_btm">
          <div class="content">
			...
			<?php if(!empty($announcement['HomepageMessage']['msg'])){?>
              <div class="announcements_panel">
                ...
                <ul class="dash_act_job">				
                  <li style="border:none;padding:0 8px 4px 8px">
				  	<?php 
					  	if(isset($announcement['HomepageMessage']['msg'])){						
	                    ...
	                    echo $announcement['HomepageMessage']['msg'];
                    ?>				
                <br />
				</li>				
                </ul>
			  ...
			  $trialAccunt = $this->Session->read('TrialAccountEmp');
			  if($trialAccunt!=1){
			   ?>
			  <div class="announcements_panel">
                ...
                <ul class="">
                  <li> 					
                   ...
                   You have <strong><?php echo  $limitJobs; ?>   </strong> job postings available.  If you would like post more listings please click the Buy Now! button to see pricing information. 
            ...
            <div class="dashboard_row">
              ...
              <div id="contentLeft">
                <ul style="width:632px;">
                  ...
                  <li style="width:300px;float:left;min-height:245px;margin:5px 5px 0px 15px;" >
                    <div class="dashboard_col_lf">
                    <h4 class="dash_heading">Employer Preparation
                    </h4>
                    <div class="step_panel">
                      <div class="steps">Step<br />
                        1</div>
                      <div class="step_detail">
                      <?php echo $this->Html->link('Enter/Update corporate profile',array('controller'=>'employers','action'=>'editprofile'),array('escape'=>false,'alt'=>'Enter/Update corporate profile'));?>
                      </div>
                      <div class="clear"></div>
                    </div>
                    <div class="step_panel">
                      ...
                      <div class="step_detail">
                        <?php
						/*
						 $postedJobs = $common->GetPostedJobNumber($this->Session->read('Auth.Client.employerContact.employer_id')); 
						if($postedJobs < 1) {
						 ?>
                       ...
                       <?php } */ ?>
                               <?php echo $this->Html->link('Upload your company logo',array('controller'=>'employers','action'=>'profileImage'),array('escape'=>false,'alt'=>'Upload your company logo','title'=>'Upload your company logo'));?>
                        </div>
                      <div class="clear"></div>
                    </div>
                    <div class="step_panel">
                      ...
                      <div class="step_detail"><!--Show Specifics: # of staff, booth size,  
                        electric/telephone needs-->
                        <?php echo $this->Html->link('Enter/Update job postings',array('controller'=>'employers','action'=>'joblists'),array('escape'=>false,'alt'=>'Upload your company logo','title'=>'Upload your company logo'));?>
                         </div>
                      <div class="clear"></div>
                    </div>
                    <!--<div class="step_panel">
              ...
              <li style="width:290px;float:left;margin:10px;min-height:245px;margin:5px 5px 0px 15px;" >
              <div class="dashboard_col_rt">
                    <h4 class="dash_heading">Active Jobs<span class="post_job_btn">
                 	<?php if($trialAccunt==1){ ?>
						<a title="Post a Job" alt="Post a Job" class="f_right padding_right view_edit" href="javascript:void(0);" onclick="trialAccountPopup()"><img src="<?php echo $this->webroot;?>img/images/post_job_btn.jpg"></a>
			  ...
			  ?>
                      <li> <span class="f_left jobname"><?php echo iconv("", "UTF-8//IGNORE", $joblist['JobPosting']['job_title']); ?></span><span>
          ...
          <div class="announcements_panel" style="background:#FFF !important;">
                <h4 class="dash_heading" >Search Resumes</h4>
                  ...
                  <ul style="width:632px;">
                 <li style="width:305px;float:left;min-height:370px;margin:5px 5px 0px 0px;" >
              <div class="dashboard_col_lf">
                    ...
                    <li>
                      <label>Security Clearance (optional):</label>
                      <br />
                   ...
                   <!--    <p class="dashfloat_none">If you have selected "Other Active Clearance" in the above menu. you may enter security clearance search keywords here (Click on instructions link above for detailed instructions)</p>
                      <p>
                ...
                <?php /*
                    <?php if($dashboard_video['EmployerVideo']['video_type']=='upload')
                        {
                        $imagePath = 'images/video.jpg';
                        }
                        else {
						$youtubeId = end(explode('/',$dashboard_video['EmployerVideo']['video']));
						$imagePath = 'http://img.youtube.com/vi/'.$youtubeId.'/0.jpg';	
                         } ?>
                    <?php 
					if($dashboard_video['EmployerVideo']['id']){
					echo $this->Html->link($this->Html->image($imagePath,array('style'=>'width:295px;')), array('controller'=>'employers','action'=>'empshowVideo/'.$dashboard_video['EmployerVideo']['id']),array('class'=>'ajax','escape'=>false,'alt'=>'My Video','title'=>'My Video'));}
					else
					{
					echo $this->Html->image($imagePath,array('style'=>'width:295px;','onclick'=>'alert("Please enter video first");','alt'=>'My Video','title'=>'My Video'));
					}	 ?>
            ...
            <li style="width:290px;float:left;min-height:370px;margin:5px 5px 0px 5px;" > 
              ...
              <div class="dashboard_col_rt">
                    ...
                    <li>
                      ...
                      <br />
                      <div class="checkbox_div_dashboard ">
                        <div class="checkbox_list statelistdrop">
                    ...
                    <li>
                      ...
                      <br />
                      <div class="checkbox_div_dashboard">
                        <div class="checkbox_list setDiv resumedblistdrop">
                        <?php echo $this->Form->input('set_id', array('type' => 'select','multiple'=>'checkbox','options' => $selected_db,'selected' => 'all','div'=>false,'label'=>false,'hiddenField' => false));?>
                      </div>
                      </div>
                    </li>
                 
                  </ul>       <div class="clear"></div> 
                    <div class="alignright viewmore_active"> <?php echo $this->Form->submit('Submit',array('type'=>'submit','alt'=>'Submit','title'=>'Submit','class'=>'front_button_new') );?> </div>
...
function checkForm(form) {
	...
	cntset_id=$(".setDiv input:checkbox").length;
	if(cntset_id==0)
	{
		alert("No database assign for search.");	
		return false;
	}
