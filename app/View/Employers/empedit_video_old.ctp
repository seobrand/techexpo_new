              ...
              <div class="gray_full_mid">
               ...
               <li>
                  ...
                  <li id="youtube_video">
                    ...
                    <div class="form_rt_col1">
                       <?php echo $this->Form->input('video',array('class'=>'smallTextB','error'=>false,'div'=>false,'lable'=>false,'value'=>$video_detail['EmployerVideo']['video']));?>
                         <br /><br />
                  ...
                  <li id="direct_upload">
                    ...
                    <div class="form_rt_col1">
                      ...
                      <?php echo $this->Form->input('video',array('type'=>'file','label'=>'','border'=>'none','div'=>'','label'=>false,'size'=>'29px;'));?>
