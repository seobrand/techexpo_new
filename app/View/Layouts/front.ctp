...
<meta property="og:image" content="<?php echo BASE_URL; ?>/img/images/logo.jpg"/>
<meta property="og:site_name" content="TechExpo"/>

<title> <?php  if(isset($meta_title_show)) { echo $meta_title_show; } else { ?>  TechExpo : <?php echo isset($meta_title) ? $meta_title : '';  }?></title> 
<meta property="og:description" content="<?php echo isset($meta_description_show) ? $meta_description_show : '';   ?>"/> 
<!--end here-->
<?php 
...
<!-- Google Analytics code start from here task id 3325-->
<script>
  ...
  ga('create', 'UA-27874911-1', 'techexpousa.com');
...
<?php // Jitendra <Include the message_popup.ctp element file for shows popup in frontend> ?>
        ...
        <ul class="top_menu">
          ...
          <li><?php echo $this->Html->link("about us",'/about_us'); ?>
          		<ul class="sub_menu">
                    ...
                    <li><?php echo $this->Html->link("Recruit @ Techexpo",array('controller'=>'users','action'=>'recruitWithUs','Jobseeker'=>false)); ?></li>
          ...
          <li>
				  ...
				  <?php if($this->Session->read('Auth.Client.User.candidate_id')){ 
                         echo $this->Html->link("events",'/Jobseeker/shows/eventList'); 
                   }
				  else if($this->Session->read('Auth.Client.employerContact.employer_id'))
				  {
				  	echo $this->Html->link("events",'/employers/empevent');
				  }
				  else{ 
                     echo $this->Html->link("events",'/shows'); 
                  } ?>
           	<ul class="sub_menu">
				<?php if($this->Session->read('Auth.Client.User.candidate_id')){ ?>
				...
				else if($this->Session->read('Auth.Client.User.user_type')=='E')
				{ 
					echo '<li>'.$this->Html->link("events",'/employers/empevent').'</li>';
				}
				else{ ?>
          ...
          <li><?php echo $this->Html->link("job seekers",array('controller'=>'candidates','action'=>'candidateprofile','Jobseeker'=>true)); ?>
          			<ul class="sub_menu">
                       <?php /*?>  	<li>
                            ...
                            <?php /*?><li><?php echo $this->Html->link("Event Photos",'/pixes'); ?></li><?php */?>
                            <li> 
          ...
          <?php } else{?>
			<li><?php echo $this->Html->link("job seekers",array('controller'=>'users','action'=>'login','Jobseeker'=>false)); ?>
            			...
            			<ul class="sub_menu">
                            ...
                            <li>
                            	<?php echo $this->Html->link("Research Companies", array('controller'=>'users','action'=>'exhibitors','Jobseeker'=>false)); ?>
                            </li>
                            <li>
                            	<?php echo $this->Html->link("Tell a Friend", array('controller'=>'users','action'=>'tellaFriend','Jobseeker'=>false),array('class'=>'ajax','escape'=>false)); ?>
                            </li>
          ...
          <ul class="sub_menu">
            ...
            <li><?php echo $this->Html->link("Recruit @ Techexpo",array('controller'=>'users','action'=>'recruitWithUs','Jobseeker'=>false)); ?></li>
            <li><?php echo $this->Html->link("POST OPEN JOBS",array('controller'=>'users','action'=>'jobposting','Jobseeker'=>false)); ?></li>
          ...
          <li ><?php echo $this->Html->link("partners",'#'); ?>
          
          	<ul class="sub_menu">
          <li><?php echo $this->Html->link("Marketing Partners",array('controller'=>'employers','action'=>'partners','Jobseeker'=>false)); ?></li>
          
          <li><?php echo $this->Html->link("Techexpo Exhibitors",array('controller'=>'users','action'=>'exihibitors','Jobseeker'=>false)); ?></li>
            <li><?php echo $this->Html->link("Continuing Education",'/training_schools'); ?></li>
            
           
          <?php /*?>	<li><?php echo $this->Html->link("Profile Exhibitors",array('controller'=>'employers','action'=>'empexhibitor','Jobseeker'=>false)); ?></li><?php */?>
            <li><?php echo $this->Html->link("Testimonials",'/testimonials'); ?></li> 
        
           	</ul>
         </li>
         <li class="last">   <?php echo $this->Html->link("Contact Us",array('controller'=>'users','action'=>'contactUs','Jobseeker'=>false)); ?></li>
        </ul>
    ...
    <div  class="statics">
    	...
    	<ul>
        	<li style="width:280px;">
            	<span style="color:#595959">Jobs with Security Clearance : </span><span>
				<?php 
            ...
            <li style="width:225px;">
            	...
            	<span style="color:#595959"> TECHEXPO Members :</span> <span>
             	<?php 
            ...
            <li style="width:400px;">
            	 <span style="color:#595959">Members with Security Clearance :</span> <span>
				 <?php 
...
<div id="wrapper" style="font-weight:normal !important;">
  <div class="foo_lf">
	<ul>
...
<a href="#?w=310" rel="trialAccountpopup_name" class="poplight" style="display:none;"><input type="hidden" id="trialAccount"/></a>
  <div id="trialAccountpopup_name" class="popup_block"><?php //echo $this->Html->image("images/close.png",array('onclick'=>'closePopup()','alt'=>'Close','title'=>'Close','class'=>'btn_close'));?>
   <div id="show_message" style="text-align:left">
...
function trialAccountPopup(){
	  document.getElementById('trialAccount').click();
}
</script>
</script>
...
$(function(){
	...
	$(".ajax").colorbox({width:'650px', height:'370px', innerHeight:'300px'});
	//$(".ajax").colorbox({width:'650px', height:'auto'});
	$(".ajax_empvideo").colorbox({width:'650px', height:'450px'});
	
	<?php  
	
	$userType=$this->Session->read('Auth.Clients.user_type');
	
	$userPass=strtolower($this->Session->read('Auth.Clients.old_password'));
			
	if($userType=='E' && $userPass=='techexpo')
			{ ?>
				
		//	$(".changepassword").colorbox({width:'650px', height:'450px'});
			$.colorbox({escKey:false,overlayClose:false,width:'600px', height:'auto',href:"<?php echo $this->Html->url(FULL_BASE_URL.router::url('/',false).'employers/changepassword', false); ?>",onLoad: function() {
				$('#cboxClose').remove();
			} });
    	<?php } 
		
		if($userType=='C' && $userPass=='techexpo')
			{ ?>
				
		//	$(".changepassword").colorbox({width:'650px', height:'450px'});
			$.colorbox({escKey:false,overlayClose:false,width:'600px', height:'auto',href:"<?php echo $this->Html->url(FULL_BASE_URL.router::url('/',false).'Jobseeker/candidates/changepassword', false); ?>",onLoad: function() {
				$('#cboxClose').remove();
			} });
    	<?php } ?>
...
<!--[if lte IE 9]><?php echo $this->Html->script('front_js/placeholderfix.js');?><![endif]-->
