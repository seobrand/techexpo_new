...
function goto_club() {
	if(document.getElementById('popup_check').value=='yes') {
		...
		if(document.getElementById('closethisLink'))
...
<div id="header">
  <!-- logo -->
  <div id="logo">
   <h1>  <?php echo $this->Html->link('TechExpo Admin Panel',array('controller'=>'adminusers','action'=>'home'),array('escape'=>false,'title'=>'TechExpo Admin Panel','alt'=>'TechExpo Admin Panel')); ?></h1>
  </div>
  <!-- end logo -->
  <!-- user -->
    ...
    <ul id="quick">
      ...
      <li><?php echo $this->Html->link('<span class="icon">'.$this->Html->image('world_link.png',array('alt'=>'Home')).'</span><span>Marketing</span>',array('#'),array('escape'=>false)); ?>          
        <ul>
          ...
          <li><?php echo $this->Html->link('Manage Newsletters',array('controller'=>'newsletters','action'=>'list')); ?></li>
        </ul>
      </li>
