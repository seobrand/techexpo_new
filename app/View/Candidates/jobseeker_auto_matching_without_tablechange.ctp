               ...
               <table class="tableWhd" width="100%" border="0" cellspacing="0" cellpadding="0">
                <thead>
                	<tr class="tableHead">
                        ...
                        <th width="97" style="text-align:left"><?php echo $this->Paginator->sort('JobPosting.work_type_code','Type of Work'); ?></th>
                        <th width="97" style="text-align:left"><?php echo $this->Paginator->sort('Employer.employer_name','Company Name'); ?></th>
                        <th width="77" style="text-align:left"><?php echo $this->Paginator->sort('JobPosting.start_dt','Date Posted'); ?></th>
                      </tr>
                 </thead>
               <tbody>
                <?php
                      ...
                      <tr>
                        <td colspan="5" class="last" style="text-align:left"><p><?php echo $value['JobPosting']['short_descr'] ?> </p>
                          ...
                          <ul class="footer_btn">
                            <li>
                              <?php
                     echo $this->Html->link($this->Html->image('images/viewjob_detail.jpg'),array('controller'=>'candidates','action'=>'jobDetails/'.$value['JobPosting']['posting_id']),array('escape'=>false,'target'=>'_blank')); ?>
                            </li>
