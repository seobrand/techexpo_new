    ...
    <div class="lf_col_inner">
      ...
      <div class="whiteB_mid">
        <div class="whiteB_bottom">
          ...
          <div class="content">
            <h2 class="mana_subheading">Notes: </h2>
			  ...
			  $i=1;
			   foreach($InterviewRec as $key=>$value){?>
            	 <tr  class="<?php if($i%2=='0') {?>tablebody<?php }else { ?>tablebody2<?php } ?> border_bottom">
                    <td  width="88"><?php echo $value['Candidate']['candidate_name'];?> </td>
                    <td  width="88"><?php echo $value['Show']['show_name'] ?> </td>
                    <td  width="68"><?php echo $value['Show']['show_dt'] ?><br /><?php echo $value['Show']['show_hours'] ?></td>
                    <td  width="88">
                      <?php 
