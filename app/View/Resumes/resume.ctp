...
<?php if(isset($this->request->data['ResumeSkill']) && count($this->request->data['ResumeSkill'])>0){
...
<div id="wrapper">
  ...
  <div id="container"> <?php echo $this->Form->create('Resume',array('action'=>'', 'enctype'=>'multipart/form-data')); ?>
      ...
      <div class="whiteB_mid">
        <div class="whiteB_bottom">
          ...
          <div class="content">
            ...
            <br />
            <!--<a href="frontend-manage-resume.html"><?php echo $this->Form->Submit('update_resume.jpg'); ?> </a><br />-->
            <br />
            ...
            <div class="gray_full_mid">
              <ul class="form_list manage_resume_form">
                <li>
                  ...
                  <div class="form_rt_col1"> <?php echo $this->Form->input('Resume.resume_title',array('class'=>'big537_textfield','label'=>false,'div'=>'','style'=>'width:386px!important;','id'=>'resume_title'));?> <br />
                ...
                <li>
                  ...
                  <div class="form_rt_col1" style="overflow:hidden"> <?php echo $this->Form->input('Resume.resume_summary',array('class'=>'textarea_398 mceNoEditor','type'=>'textarea','label'=>false,'div'=>false,'style'=>'width:400px;overflow:hidden;height:80px;','id'=>'resume_summary'));?> <br />
             ...
             Please upload your PDF or Word Document version of your resume.
              ...
              <div class="man_resume_footer padding_right_none">
                ...
                <ul>
                  ...
                  <li> <?php echo $this->Form->input('Resume.captcha',array('autocomplete'=>'off','value'=>'','label'=>false,'class'=>'inputType','div'=>'','style'=>'width:250px;height:24px;')); ?>
                ...
                <div class="align_right">
                  <?php echo $this->Form->input('Update',array('name'=>'Update','value'=>'Update','type'=>'hidden')); ?>
                  <?php echo $this->Form->submit('images/create-resume.png',array('name'=>'Update','value'=>'Update','class'=>'cursorclass ui-state-default ui-corner-all','div'=>false));?> </div>
              </div>
            </div>
          </div>
        </div>
