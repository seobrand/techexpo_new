...
<div id="container">
    <?php echo $this->Form->create('Resume',array('action'=>'edit_resume/', 'enctype'=>'multipart/form-data')); ?>
          ...
          <div class="whiteB_bottom">
            ...
            <div class="content">
              ...
              <div class="gray_full_mid">
                <ul class="form_list manage_resume_form">
                  ...
                  <li>
                    ...
                    <div class="form_rt_col1">
                      <?php echo $this->Form->input('Resume.resume_summary',array('class'=>'textarea_237','type'=>'textarea','label'=>false,'div'=>''));?>
                      <br />
              ...
              <tr>
                <td class="table_hd"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <th width="129" style="text-align:center">Last Used</th>
              ...
              <tr>
                <td class="table_row border_bottom"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <?php echo $this->Form->input('ResumeSkill.0.id',array('class'=>'big237_textfield','type'=>'hidden','label'=>false,'div'=>''));?>
                      ...
                      <td  width="129" class="normalfont" style="text-align:left"><div class="dropdown_resume3">
                          <?php 
              ...
              <tr>
                <td class="table_row border_bottom alternate"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td  width="195" style="text-align:left"><div class="dropdown_resume1">
                      <?php echo $this->Form->input('ResumeSkill.1.id',array('class'=>'big237_textfield','type'=>'hidden','label'=>false,'div'=>''));?>
                          <?php 
              ...
              <tr>
                <td class="table_row border_bottom"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <?php echo $this->Form->input('ResumeSkill.2.id',array('class'=>'big237_textfield','type'=>'hidden','label'=>false,'div'=>''));?>
                          <?php 
              ...
              <tr>
                <td class="table_row border_bottom alternate"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td  width="195" style="text-align:left"><div class="dropdown_resume1">
                      <?php echo $this->Form->input('ResumeSkill.3.id',array('class'=>'big237_textfield','type'=>'hidden','label'=>false,'div'=>''));?>
                          <?php 
              ...
              <tr>
                <td class="table_row border_bottom"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td  width="195" style="text-align:left"><div class="dropdown_resume1">
                      <?php echo $this->Form->input('ResumeSkill.4.id',array('class'=>'big237_textfield','type'=>'hidden','label'=>false,'div'=>''));?>
                          <?php 
              ...
              <h2 class="mana_subheading">3. Please paste your resume in the text area below.</h2>
                 <div class="gray_full_top"></div>
              <div class="gray_full_mid">
                <?php echo $this->Form->input('Resume.resume_content',array('class'=>'big_textarea','type'=>'textarea','label'=>false,'div'=>''));?>
           ...
           <h2 class="mana_subheading">3. Upload Resume.</h2>
            <div class="gray_full_top"></div>
             ...
             Old file: <?php echo $this->request->data['Resume']['filename']; ?>
              <?php echo $this->Form->input('Resume.oldfile',array('class'=>'textarea_237','type'=>'hidden','label'=>'','border'=>'none','div'=>'','value'=>$this->request->data['Resume']['filename']));?>
 ...
 <ul>
                  <li class="last">
                    ...
                    <?php //echo $this->Form->submit('Delete',array('name'=>'Delete','value'=>'Delete','class'=>'cursorclass ui-state-default ui-corner-all','div'=>false));?> </li>
 ...
 <div class="align_right">
 	...
 	<?php echo $this->Form->input('Resume.id',array('class'=>'big237_textfield','type'=>'hidden','label'=>false,'div'=>''));?>
    
    
                  <?php echo $this->Form->submit('Update',array('name'=>'Update','value'=>'Update','onClick'=>'return checkTotalResume(0);','class'=>'cursorclass ui-state-default ui-corner-all','div'=>false));?> 
 </div>
 </div>
              </div>
