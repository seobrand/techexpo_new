...
<div id="wrapper"> <?php echo $this->element('jobSeekerMenu', array('cache' => true)); ?>
  <div id="container"> <?php echo $this->Form->create('Resume',array('action'=>'upload_resume', 'enctype'=>'multipart/form-data')); ?>
            ...
            <div class="gray_full_mid">
              <ul class="form_list manage_resume_form">
                ...
                <li>
                  ...
                  <div class="form_rt_col1"> <?php echo $this->Form->input('Resume.resume_title',array('class'=>'big537_textfield','label'=>false,'div'=>'','id'=>'resume_title'));?> <br />
                ...
                <li>
                  ...
                  <div class="form_rt_col1" style="overflow:hidden"> <?php echo $this->Form->input('Resume.resume_summary',array('class'=>'textarea_237 smallTextB mceNoEditor','type'=>'textarea','label'=>false,'div'=>false,'style'=>'width:400px;overflow:hidden;height:80px;','id'=>'resume_summary'));?>
            ...
            <table class="tableWhd" width="100%" border="0" cellspacing="0" cellpadding="0" id="keyword_add_more_<?php echo $i;?>" <?php if($i<=count($keywordsData)){?>style="display:block;"<?php }else{?>style="display:none;"<?php }?>>
              ...
              <tr>
                <td class="table_row border_bottom"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td  width="100" style="text-align:left"><div class="dropdown_resume1" id="skillDropdown<?php echo $i;?>">
                          <?php
            ...
            <div class="gray_full_mid"> <?php echo $this->Form->input('Resume.resume_content',array('class'=>'big_textarea','type'=>'textarea','label'=>false,'div'=>''));?> <br />
              ...
              <div class="man_resume_footer padding_right_none">
                ...
                <div class="align_right">
				  ...
				  echo $this->Form->submit('images/create-resume.png',array('name'=>'Update','value'=>'Update','class'=>'cursorclass ui-state-default ui-corner-all','div'=>false));?>
                </div>
              </div>
            </div>
          </div>
    ...
    <?php echo  $this->Form->end();?> <?php echo $this->element('jobSeekerSidebar', array('cache' => true)); ?>
    <div class="clear"></div>
