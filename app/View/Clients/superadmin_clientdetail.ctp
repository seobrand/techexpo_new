<div class="display_row">
  <div class="table"><br/>
    <table cellspacing="0" cellpadding="0" border="0">
      ...
      <tr>
        <td><p style="margin:0 0 0 8px">Contact: <?php echo $employer['EmployerContact']['contact_name'];?> &nbsp;&nbsp;&nbsp;City: <?php echo $employer['Employer']['city']; ?> &nbsp;&nbsp;&nbsp;State: <?php echo $employer['Employer']['state']; ?><br />
            E-mail: <?php echo strip_tags($employer['EmployerContact']['contact_email']);?><br />
