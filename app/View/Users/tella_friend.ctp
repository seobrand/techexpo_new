...
<table  style="width:500px;text-align:center;height:300px;" >
  ...
  <tr>
    <td align="center" class="content"><form action="<?php echo FULL_BASE_URL.router::url('/',false);?>users/tellaFriend" method="post">
        <table class="popup_textexpo" height="200px" width="400">
          ...
          <tr>
            ...
            <td><input type="hidden" name="SUBMIT" value="SUBMIT" />
              <input type="image" name="SUBMIT" value="SUBMIT" onclick="return validationCheck();" src="<?php echo FULL_BASE_URL.router::url('/',false);?>/img/images/send.jpg" style="float:left !important;left:0px;"/>
              
                <input type="text" value="" class="extrafields" name="friendabout"  />
              </td>
          </tr>
        </table>
        </div>
