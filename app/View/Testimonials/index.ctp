          ...
          <div class="whiteB_bottom">
            <div class="content">
              ...
              <div class="wrap_testy">
                ...
                $user_id=$testimonail['Testimonial']['user_id'];
			if($user_id){
				...
				?>
				 ...
				 if($profileImage && file_exists('upload/150x80_'.$profileImage))
                      ...
                      <img src="<?php echo $this->webroot; ?>thumbnail.php?file=<?php echo 'upload/'.$profileImage;?>&maxw=115&maxh=140" style="margin:7px 0 0 -10px!important;"  />
                       
                      <?php 
					  	 }
							  else if(!empty($testimonail['Testimonial']['logo_file']) && file_exists('img/testimonial/'.$testimonail['Testimonial']['logo_file'])){ ?>
                            
							  <img src="<?php echo $this->webroot; ?>thumbnail.php?file=<?php echo 'img/testimonial/'.$testimonail['Testimonial']['logo_file'];?>&maxw=120&maxh=90" style="margin:7px 0 0 -10px!important;"  alt=""/>  <?php
						}
					  else
					  {
					   ...
					   ?>
                            ...
                            <div class="testi_description">
                              <p class="indent_testimonial_remove" style="padding: 6px 0 15px;">
             <?php echo htmlspecialchars_decode($testimonail['Testimonial']['text'], ENT_QUOTES);?>
                              </p>
                              <p><span class="italic">
				 ...
				 ?>
                          <li>
                            ...
                            <?php if($profileImage && file_exists('upload/150x80_'.$profileImage)){ ?>
							  ...
							  <img src="<?php echo $this->webroot; ?>thumbnail.php?file=<?php echo 'upload/'.$profileImage;?>&maxw=120&maxh=90" style="margin:7px 0 0 -10px!important;"  alt="<?php echo $profile_description; ?>"/>
                                <?php
								 }
							  else if(!empty($testimonail['Testimonial']['logo_file']) && file_exists('img/testimonial/'.$testimonail['Testimonial']['logo_file'])){ ?>
					  ...
					  echo $this->Html->image('testimonial/no_image.jpg',array('style'=>'margin:7px 0 0 -10px!important;width:120px;'));
                            ...
                            <div class="testi_description">
                              <p class="indent_testimonial_remove" style="padding: 6px 0 15px;">
                                <?php 
								  echo iconv("", "UTF-8//IGNORE", $testimonail['Testimonial']['text']); 
