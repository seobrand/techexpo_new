...
<div id="right2"> 
        ...
        <div class="box1"> 
          ...
          <div class="title-pad">
            <div class="title">
              <h5 style="width:97%;">
                <div style="float:left;">Why Attend</div>
...
<?php echo $this->Form->create('Testimonial',array('action'=>'whyattend','inputDefaults'=>array('div'=>false,'error'=>false,'label'=>false))); ?>
          ...
          <tbody> 
            ...
            <tr>
              ...
              <?php
                ...
                echo $this->Form->hidden('PageContent.page_name',array('value'=>'why_attend'));
                echo $this->Form->end();                                
              ?>
              </td>
            </tr>
