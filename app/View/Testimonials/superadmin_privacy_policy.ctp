<?php  echo $this->element('admin-breadcrumbs',array('pageName'=>'privacyPolicy')); ?>
<div id="right2"> 
        <!-- table -->
        <div class="box1"> 
          <!-- box / title -->
          <div class="title-pad">
            <div class="title">
              <h5 style="width:97%;">
                <div style="float:left;">Privacy Policy</div>
...
<?php echo $this->Form->create('Testimonial',array('action'=>'privacyPolicy','inputDefaults'=>array('div'=>false,'error'=>false,'label'=>false))); ?>
          ...
          <tbody> 
            ...
            <tr>
              ...
              <?php
                ...
                echo $this->Form->hidden('PageContent.page_name',array('value'=>'privacy_policy'));
                echo $this->Form->end();                                
              ?>
              </td>
            </tr>
