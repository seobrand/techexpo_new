<?php  echo $this->element('admin-breadcrumbs',array('pageName'=>'AddExhibitor')); ?>
<div id="right2"> 
        <!-- table -->
        <div class="box1"> 
          <!-- box / title -->
...
<?php echo $this->Form->create('Exhibitor',array('action'=>'add','type'=>'file','inputDefaults'=>array('div'=>false,'error'=>false,'label'=>false))); ?>
...
<td width="74%"  align="left" valign="top"><?php echo $this->Form->input('Exhibitor.description',array('class'=>'inputbox12','type'=>'textarea','cols'=>100,'rows'=>30));?>
            ...
            <tr id="imagesection">
              ...
              <?php echo $this->Form->input('Exhibitor.image',array('type'=>'file')); ?>  </td>
            </tr>
            ...
            <tr>
              ...
              <td align="left" valign="top">
              <?php
                echo $this->Form->input('Add exhibitor',array('type'=>'submit','class'=>'cursorclass ui-state-default ui-corner-all'));
              ?>
              </td>
            </tr>
          </tbody>
