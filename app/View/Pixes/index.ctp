...
<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".group1").colorbox({rel:'group1' ,maxWidth:"800px", maxheight:"600px", width:"800px", height:"600px"});
          ...
          <div class="content">
            ...
            <div class="gray_full_mid event_padding1" style="padding-top:35px;">
              <ul class="eventPic_list">
                <?php 
				$Full_url=FULL_BASE_URL.router::url('/',false).'img/event-pics/';
                ...
                <li>
                  <div class="event_pic_panel">
                    <?php
						...
						{
							// task id 4049
						 	//echo $this->Html->link($this->Html->image('event-pics/resized_'.$event_list['Pix']['pic_filename'],array('height'=>'174','width'=>'226')),$Full_url.$event_list['Pix']['pic_filename'],array('escape'=>false,'class'=>'group1','title'=>$event_list['Pix']['pic_title'],'data-fancybox-group'=>'gallery'));
							echo '<a data-fancybox-group="gallery" title="'.$event_list['Pix']['pic_title'].'" class="group1 cboxElement" href="'.$Full_url.$event_list['Pix']['pic_filename'].'"><img src="'.$this->webroot.'thumbnail.php?file=img/event-pics/'.$event_list['Pix']['pic_filename'].'&maxw=230&maxh=176"  /></a>';
						}
						 ?>
                  </div>
                </li>
