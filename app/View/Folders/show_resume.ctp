<?php 	$firstSting = $this->Session->read('search_db_word');   ?>
<style>
.highlight {
...
<div id="wrapper"> <?php echo $this->element('employer_tabs', array('cache' => true)); ?>
                ...
                <table  width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td class="table_row border_bottom alternate"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td class="last" style="text-align:left"><ul class="footer_btn">
                              <?php if(!empty($previousResumeId)){  ?>
                              <li> <?php echo $this->Html->link($this->Html->image("images/prev_resume.png"), array('controller'=>'folders','action'=>'showResume',$previousResumeId),array('escape'=>false)); ?> </li>
                              <?php } ?>
                              <?php if(!empty($nextResumeId)){  ?>
                              <li> <?php echo $this->Html->link($this->Html->image("images/next_resume.jpg"), array('controller'=>'folders','action'=>'showResume',$nextResumeId),array('escape'=>false)); ?> </li>
                              <?php } ?>
                              <!--<li>
                     
                      <?php // echo $this->Html->link($this->Html->image("images/back-search.jpg"), array('controller'=>'folders','action'=>'searchRegCandidate'),array('escape'=>false)); ?>
                                  <a href="<?php echo BASE_URL.$this->Session->read('search_db_url'); ?>">
                            ...
                            <div class="search_resume_midpanel">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td width="225"><label>File resume to folder:</label>
                                    <?php echo $this->Form->create('Folder',array('name'=>'showResume','id'=>'showResume','action'=>'showResume/'.$resume_id));?> <?php echo $this->Form->hidden('resume_id',array('value'=>$candidateRec['Resume']['id']));?> <?php echo $this->Form->input('copy_folder_id',array('label'=>false,'options'=>$folderList,'type'=>'select','div'=>false));?> <?php echo $this->Form->submit('File',array('div'=>false,'name'=>'Submit'));?> <?php echo $this->Form->end();?></td>
                                  <?php }?>
                                  <td <?php if(count($folderList)>0){?>width="225"<?php }else{?> colspan="2"<?php }?>><label>Create a new folder:</label>
                                    <?php echo $this->Form->create('Folder',array('name'=>'resumeFolder','id'=>'resumeFolder','action'=>'createresumefolder/showResume/'.$resume_id));
                  ...
                  ?></td>
                                  <td><?php echo $this->Html->link($this->Html->image("images/go-to-resume-folder.jpg"), array('controller'=>'folders','action'=>'resumefolder'),array('escape'=>false)); ?></td>
                                </tr>
                              </table>
                            </div>
                    ...
                    <li>
                      ...
                      <?php echo $this->Html->link($this->Html->image("images/download_resume.jpg"), array('controller'=>'folders','action'=>'exportResume',$candidateRec['Resume']['id']),array('escape'=>false)); ?>
                    </li>
                    <li>
  ...
  ?>
                  ...
                  <li> <a href="mailto:<?php echo $candidateRec['Candidate']['candidate_email']; ?>" target="blank"> <?php echo $this->Html->image("images/email_frnd.jpg"); ?></a> </li>
                  <li> <?php echo $this->Html->link($this->Html->image("images/forward-resume.jpg"), array('controller'=>'folders','action'=>'mailResume',$candidateRec['Resume']['id']),array('target'=>'blank','escape'=>false)); ?> </li>
                  <!--    <li>
            ...
            <h2 class="mana_subheading">
              <div class="mana_subheading_lf">Candidate Summary and Core Skills</div>
              <span class="mana_subheading_rt">
              <?php  if(count($currentfolderList)) { ?>
              Resume filed to:
              <?php } foreach($currentfolderList as $cfolder){ echo $cfolder['Folder']['folder_descr'].',';   }  ?>
              </span> </h2>
            <div class="gray_full_top"></div>
            <div class="gray_full_mid">
              <div class="preview_lf">
                ...
                <p><strong>Current Title : </strong>
                  <?php if($candidateRec['Candidate']['candidate_title'])echo $candidateRec['Candidate']['candidate_title']; else echo "N/A"; ?>
                </p>
              ...
              <div class="preview_rt">
                ...
                <p class="coreSkill"><span><strong>
                  ...
                  <?php if(!empty($ResumeEXp)) echo '( '.$ResumeEXp.' )';  ?>
                </p>
                <?php 
              ...
              <div class="preview_panel resume_highlight">
                ...
                <?php 
                  //echo nl2br($candidateRec['Resume']['resume_content']);
                    echo iconv("", "UTF-8//IGNORE", nl2br($candidateRec['Resume']['resume_content']));
				  //echo iconv("UTF-8", "ISO-8859-1//IGNORE", nl2br($candidateRec['Resume']['resume_content']));
                   ?>
              </div>
