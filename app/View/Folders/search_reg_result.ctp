...
<?php echo $this->element('employer_tabs', array('cache' => true)); ?>
	...
	<div class="pager_panel">        
        <div class="pager">     
         <div class="paging"> <?php if(isset($countTotalRecords)) echo $countTotalRecords;  ?> resumes matching your search </div>		
		<?php if($countTotalRecords>10){?>
		<br/>
   		<div class="paging">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                       <tr>
						...
						echo $resumeList['Candidate']['candidate_name'] ;
						
						 ?></td>
                      
                  <!--      <td width="125" style="text-align:left">2134</td> -->
                        <td width="125" style="text-align:left">
                         <?php  echo $this->Html->link($resumeList['Resume']['resume_title'], array('controller'=>'folders','action'=>'showRegisterResume',$resumeList['Resume']['id']),array('target'=>'blank','escape'=>false)); ?>  
                        </td>
                         <td width="125" style="text-align:left"><?php  echo $resumeList['Candidate']['candidate_state'];  ?><br />

<?php  echo $resumeList['Candidate']['candidate_city'];  ?> </td>
                           <td width="125" style="text-align:left">
                            <?php echo date(DATE_FORMAT,strtotime($resumeList['Resume']['posted_dt']));?>
                           </td>
...
<p><?php  echo $resumeList['Resume']['resume_summary'];  ?></p>

<p><strong>Overall years of experience : </strong> <?php  echo $common->getExperienceValue($resumeList['Candidate']['experience_code']);  ?> <strong> Citizenship : </strong><?php  echo $common->getCitizenShipValue($resumeList['Candidate']['citizen_status_code']);  ?></p>
...
<p><strong>Skills / Keywords:</strong> 
 ...
 <?php 
					   ...
					   if ( ($pos !== false) || ($pos2 !== false) || ($pos3 !== false) ) { 
							...
							$advancSrchKeywordSh = $this->Session->read('advancSrchKeywordSh');
							foreach($advancSrchKeywordSh as $adk)
							{ 
					   ...
					   { 
						 echo substr_count(strtoupper($resumeList['Resume']['resume_content']), strtoupper($this->Session->read('search_reg_word')));  ?> hits on '<?php  echo $this->Session->read('search_reg_word'); ?>'  
						 <?php } ?>
   </p>
<p>                <?php 
...
<ul class="footer_btn">
                  <li style="padding:0px">
                       ...
                       <?php echo $this->Html->link($this->Html->image("images/viewresume_details.jpg"), array('controller'=>'folders','action'=>'showRegisterResume',$resumeList['Resume']['id']),array('target'=>'blank','escape'=>false)); ?>   
                  </li>
                  <li style="padding:0px">
...
if(!empty($resumeList['Resume']['filename']) && file_exists('candidateDocument/resume/'.$resumeList['Resume']['filename']))
{
    ...
    if($file_type==".pdf"){
		echo $this->Html->link($this->Html->image("images/download.jpg"), array('controller'=>'folders','action'=>'downloadResume',$resumeList['Resume']['filename'],'pdf'),array('escape'=>false));
	}else{
...
?>
             ...
             <a href="mailto:<?php echo $resumeList['Candidate']['candidate_email']; ?>" target="blank"> <?php echo $this->Html->image("images/email-candidate.jpg"); ?></a>
                  </li>
                </ul>
