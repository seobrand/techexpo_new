...
class PaypalComponent extends Component
{
	...
	function UpdateAccessPermissions($PayerID)
	{
        ...
        function initializePaypalConfiguration(){
            ...
            $api_username = $sandbox ? 'piyush_1281605734_biz_api1.planetwebsolution.com' : 'mark_api1.markram.ca';
            $api_password = $sandbox ? '1281605803' : 'X2NTB5DJCHU4BUP8';
            $api_signature = $sandbox ? 'AOxbXD.OVjBjleHl5GMG8.wewNOAAOWEavAwDFMCtmDQTpzToceEQ1Tk' : 'AFcWxV21C7fd0v3bYYYRCpSSRl31AEB41wHZ9SwpDu8vUu1tsMgKF.N4';
            ...
            $PayPal = $this->construct($PayPalConfig);
            return $PayPal;
        }
	
}

class PayPal_Adaptive extends PaypalComponent
{
