...
class AdminusersController extends AppController {
	...
	******************************************************************/
	 ...
	 if ($this->request->is('post')) {
			...
			if(!$errorsArr){
				...
				if($userInfo!==false){
					...
					$bodyText = 'Dear '.$username.',<br/><br/>Here is your login information to gain access to www.TechExpoUSA.com:<br/><br/>Username:  '.$userInfo['Adminuser']['username'].'<br/>Password:  '.$userInfo['Adminuser']['orig_password'].'<br/>Thank you for your continued support and feel free to e-mail webmaster@TechExpoUSA.com with any questions.<br/><br/>Best Regards,<br/><br/>The TECHEXPO Team.';
	...
	function superadmin_home() {
		/* echo "<pre>";
		print_r($this->Session->read('Auth.User'));die; */
