 ...
 */
	public function superadmin_index() { 
        ...
        $this->paginate = array('limit' =>$record,'order' => array('Show.show_dt' => 'ASC'));
 ...
 */
	public function superadmin_edit($location_id = null) {
			...
			if ($this->request->is('get')) {
				$this->request->data = $this->Location->find('first',array('conditions'=>array('location_id'=>$location_id)));
			} else {
				$this->Location->set($this->request->data);	
